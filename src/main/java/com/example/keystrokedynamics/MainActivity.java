        ...
        t0.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t0_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t0_keyPressedDuration/1000;
                    if (current_pointer != 0) {
        ...
        t1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t1_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t1_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        t2.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    /*if((double) event.getPressure() > 1){
                        pressure_t = (double) event.getPressure() / 1000;
                    }else{                         pressure_t = (double) event.getPressure();
                    }*/
                    t_pressure[current_pointer] = (double) event.getPressure();
                    if (current_pointer != 0) {
                        difference[current_pointer - 1] =((starttime[current_pointer] - starttime[current_pointer - 1] - presstime[current_pointer - 1]*1000)/1000);
                    }
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                    t2_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t2_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] =(presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] =(presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        t3.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t3_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t3_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                   ...
                   /* if((double) event.getPressure() > 1){
                    ...
                    t4_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t4_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        t5.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t5_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t5_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        t6.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t6_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t6_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        t7.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t7_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t7_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        t8.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    t8_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t8_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                   ...
                   /* if((double) event.getPressure() > 1){
                    ...
                    t9_keyPressedDuration = ((System.currentTimeMillis() - lastDown));
                    presstime[current_pointer] = t9_keyPressedDuration/1000;
                    if (current_pointer != 0) {
                        digraph[current_pointer - 1] = (presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1]);
                        if (current_pointer > 1) {
                            trigraph[current_pointer - 2] = (presstime[current_pointer - 2] + presstime[current_pointer - 1] + presstime[current_pointer] + difference[current_pointer - 1] + difference[current_pointer - 2]);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checksum && current_pointer >= app_password.length()) {
                    ...
                    cv.put(Database.b1_x, t_x[0]); //cordinates values of buttons
